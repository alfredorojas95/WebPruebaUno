...
<body class="cuerpo"><br>
		...
		<div class="caja">
			...
			<!--Inicio caja bajada-->
			<div class="bajada" ><br>
			<h3>Registrar Asistencia del estudiante en curso</h3>
			</div>
			<!--Fin caja bajada-->
			...
			<!--Inicio caja datos-->
			<div class="entrada">
				<form action="RegistrarAsistencia" method="get" class="form-horizontal">
				    ...
				    <div class="form-group">
				    	<label class="col-sm-2 control-label">Asistencia:</label>
				    	<div class="col-sm-10">
				    		<input type="text" class="form-control" name="asistencia"  placeholder="Porcentaje de asistencia" required>
				    	</div>
				    </div>
				    ...
				    <div class="form-group">
				    	...
				    	<div class="col-sm-10">
				    		<input type="text" class="form-control" name="idCurso"  placeholder="id Curso" required>
				    	</div>
				    </div>
				    ...
				    <div class="form-group">
				  	...
				  	<div class="form-group">
				  		<div class="col-sm-offset-2 col-sm-10">
				  			<button type="submit" class="btn btn-default" name="enviar">Registrar Asistencia</button>
				  		</div>
				  		<p>${mensaje1}</p>
				  	</div>
